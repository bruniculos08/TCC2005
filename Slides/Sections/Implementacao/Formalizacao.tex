...
H : forall i : 'I_p, P i
                ...
                \item[]
                \item[{$\blacktriangleright$}] A notação \coqinline[]{:> X} após uma igualdade indica uma coerção de ambos os lados da equação para o tipo \coqinline[]{X}; como exemplo tem-se o lema:
                    \begin{lstlisting}[language=coq,frame=single,tabsize=1]
