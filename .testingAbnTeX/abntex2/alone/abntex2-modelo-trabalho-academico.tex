...
\begin{algorithm}[H]
	...
	% \eSe{$a = 0$}
	%     {\Retorna{$b$}}
	%     {\Retorna{\nameref{algo:euclides}($b$, $a \bmod b$)}}
\end{algorithm}

\begin{figure}[h]
        \centering
        \caption{Grafo do módulo ssreflect}
        \includegraphics[width=0.6\textwidth]{Captura de tela de 2024-09-19 11-21-46.png}\\
