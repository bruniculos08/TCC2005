...
Open Scope hb_scope.
        ...
        \item \label{item:mixin-monoid} Declação de um \textit{mixin} por meio do comando \coqinline[]{HB.mixin}; este comando recebe um \textit{record} que deve possuir um parâmtero de tipo \coqinline[]{Type} junto com uma lista possívelmente vazia de dependências 
