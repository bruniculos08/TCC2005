...
\begin{figure}[h]
    ...
    \footnotesize{Fonte: adaptado de \citeauthor{grafo-ssreflect}, \citeyear{grafo-ssreflect}.
...
Definition eq_axiom T (e : rel T) := forall x y, reflect (x = y) (e x y).
    \end{lstlisting}
    \footnotesize{Fonte: \citeauthor{mathcomp-eqtype}, \citeyear{mathcomp-eqtype}.
    }
