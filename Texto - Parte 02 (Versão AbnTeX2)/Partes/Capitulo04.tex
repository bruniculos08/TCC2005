...
O primeiro lema foi provado na biblioteca Mathematical Components e trata do caso \ref{item:caso3wilson} do Teorema \ref{teorema : wilson} e possui, na biblioteca, o seguinte enunciado:
