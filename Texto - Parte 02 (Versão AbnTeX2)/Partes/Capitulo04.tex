...
rewrite !inE.                                           @ \label{line:66-item4b-item2} @
                        ...
                        \begin{enumerate}[listparindent=\parindent]
                                ...
                                \item[\textbf{(\ref{line:41-item4b-item2})}] Reescrita utilizando \lstinline[language=coq]|prod_nat_const|, lema este que possui o seguinte enunciado \cite{mathcomp-bigop}:
...
(i \in (fun i0 : 'F_p => eqn (i0.+1 - f i0) 0)) = (i \in [predI A & B])
                                ...
                                \item[\textbf{(\ref{line:66-item4b-item2})}] Ambas as expressões da igualdade podem ser simplificadas com o uso da tupla \lstinline[language=coq]|inE| diversas vezes, por isso para realizar o máximo de reescritas possíveis é utilizado ``\lstinline[language=coq]|!|'' \cite{assia_mahboubi_2022_7118596} antes do nome da tupla. Obtêm-se então a seguinte expressão no \textit{goal}:
